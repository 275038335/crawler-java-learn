package com.chinaredstar.jc.crawler.biz.test.chrome;
...
public class TestChromeDriver {
    ...
    public static WebDriver getChromeDriver() throws IOException {
       ...
       service = new ChromeDriverService.Builder().usingDriverExecutable(new File("D:\\chromedriver\\chromedriver_win32\\chromedriver.exe")) .usingAnyFreePort().build();
        service.start();
        // 创建一个 Chrome 的浏览器实例
