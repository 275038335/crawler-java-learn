...
public class TaoBaoShopInfoProcessor implements PageProcessor {
    ...
    @Autowired
    private TaoBaoShopInfoService service=new TaoBaoShopInfoService();
...
//                int size=urls.size();
                ...
                Spider spider = Spider.create(this).setDownloader(new SeleniumDownloader(5000, pool, new TestAction()))
                        .addUrl(urlStrs);
